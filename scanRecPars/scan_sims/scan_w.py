...
out_base_dir='/data1/maldera/IXPE_work/rec_optimization/simData/scan_w/'
data_base_dir='/data1/maldera/IXPE_work/rec_optimization/simData/'

#dirs=['2KeV',  '3KeV',  '4KeV',  '5KeV',  '6KeV',  '7KeV','8KeV']
dirs=['2KeV',  '3KeV',  '5KeV',   '6KeV',  '7KeV','8KeV']
#dirs=['3KeV',  '4KeV',   '6KeV',  '7KeV','8KeV']
...
for dir in dirs:
  for  angle_dir in angle_dirs:
    ...
    for weight_scale in np.arange (0.01, 0.21,0.01):
