...
dataBest=readDataBest('/home/maldera/IXPE/rec_optimization/data1/maldera/IXPE_work/rec_optimization/bestParams/outBestParams.txt')
...
#gDmin_3d=ROOT.TGraph(len(data3d.energy), data3d.energy.flatten('C'),  data3d.best_var1.flatten('C') )
#flatten(‘C’), 
