...
#Rmin
base_dir='/data1/maldera/IXPE_work/rec_optimization/unpolDFF/bestPara_phaParametrization/'
#max_iter=17+1
#max_iter=2                                                
...
for dirName in energy_dirs:
    ...
    work_dir1=out_dir+'/'+eps_dir[dirName][0]
    work_dir2=out_dir+'/'+eps_dir[dirName][1]
