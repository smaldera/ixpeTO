...
class myTTree:    
    ...
    def Fill(self,xpeSimo):
        ...
        self.barycenterY[0]=xpeSimo.baricenter.y()
        self.barycenterX[0]=xpeSimo.baricenter.x()

        self.absorptionX[0]=xpeSimo.conversion_point.x()
        self.absorptionY[0]=xpeSimo.conversion_point.y()
        
        self.size[0]= xpeSimo.cluster.num_pixels()
        self.pulse_height[0]=xpeSimo.cluster.pulse_height
        #self.num_tracks=
               
        self.mom2trans[0]=xpeSimo.recon.ma0.mom2_trans
        self.mom2long[0]=xpeSimo.recon.ma0.mom2_long
        self.skweness[0]=xpeSimo.recon.mom3_long
